...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen items-center justify-center px-4 md:px-12 lg:px-20 py-12 bg-gray-900 text-white">
      ...
      <h2 className="text-lg sm:text-lg mb-6 text-center">Try some of the <a className="text-slate-400" target="_blank" href="https://sirv.com/help/articles/dynamic-imaging/">100+ image processing options</a> available</h2>
